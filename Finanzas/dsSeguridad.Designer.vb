    ...
    Partial Public Class USUARIOTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        cve_empleado, nombre + ' ' + ape_pat + ' ' + ape_mat AS nombrecompl"& _ 
                ...
                "zar"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            USUARIO"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        cve_empleado, nombre + ' ' + ape_pat + ' ' + ape_mat AS nombrecompl"& _ 
                "eto, correo, tel_particular, jefe, id_usuario, password, fecha_ingreso, estado, "& _ 
                "rfc, tel_oficina, direccion, CveEmpresa, id_puesto, id_depto, id_sucursal, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   "& _ 
                "                      Huella1, Huella2, Huella3, Bloqueo, FechaCaducidad, Autori"& _ 
                "zar"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            USUARIO"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (cve_empleado = @cve_empleado)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@cve_empleado", Global.System.Data.SqlDbType.VarChar, 8, Global.System.Data.ParameterDirection.Input, 0, 0, "cve_empleado", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
