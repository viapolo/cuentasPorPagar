Public Class frmSucursales
    ...
    Private Sub frmSucursales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'DsProduction.Sucursales' Puede moverla o quitarla según sea necesario.
        Me.SucursalesTableAdapter.Fill(Me.DsProduction.Sucursales)
    ...
    Private Sub CXP_SucursalesBindingNavigatorSaveItem_Click_1(sender As Object, e As EventArgs)
