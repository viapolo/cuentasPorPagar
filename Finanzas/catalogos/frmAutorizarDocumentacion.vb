...
Public Class frmAutorizarDocumentacion
    ...
    Protected Sub enviaCorreoDocumentos(documento As String, razonSocial As String, rfc As String, solicitante As String, textoEncabezado As String, asuntoMensaje As String, comentarios As String, preautorizante As String, mailDestinatario As String)
