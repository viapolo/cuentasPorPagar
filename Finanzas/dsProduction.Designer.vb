...
Partial Public Class dsProduction
    ...
    Partial Public Class CXP_EmpresasDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddCXP_EmpresasRow(ByVal razonSocial As String, ByVal rfc As String, ByVal calle As String, ByVal numeroInterior As String, ByVal numeroExterior As String, ByVal colonia As String, ByVal delegacion As String, ByVal estado As String, ByVal pais As String, ByVal codigoPostal As String, ByVal idMoneda As Decimal, ByVal condicionesDePago As String, ByVal idRegimenFiscal As Decimal) As CXP_EmpresasRow
            Dim rowCXP_EmpresasRow As CXP_EmpresasRow = CType(Me.NewRow,CXP_EmpresasRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, razonSocial, rfc, calle, numeroInterior, numeroExterior, colonia, delegacion, estado, pais, codigoPostal, idMoneda, condicionesDePago, idRegimenFiscal}
        ...
        Private Sub InitClass()
            ...
            Me.columnidMoneda = New Global.System.Data.DataColumn("idMoneda", GetType(Decimal), Nothing, Global.System.Data.MappingType.Element)
            ...
            Me.columnidRegimenFiscal = New Global.System.Data.DataColumn("idRegimenFiscal", GetType(Decimal), Nothing, Global.System.Data.MappingType.Element)
    ...
    Partial Public Class CXP_EmpresasRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Property idMoneda() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableCXP_Empresas.idMonedaColumn),Decimal)
                Catch e As Global.System.InvalidCastException
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Property idRegimenFiscal() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableCXP_Empresas.idRegimenFiscalColumn),Decimal)
                Catch e As Global.System.InvalidCastException
    ...
    Partial Public Class CXP_EmpresasTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [CXP_Empresas] ([razonSocial], [rfc], [calle], [numeroInterior], [num"& _ 
                "eroExterior], [colonia], [delegacion], [estado], [pais], [codigoPostal], [idMone"& _ 
                "da], [condicionesDePago], [idRegimenFiscal]) VALUES (@razonSocial, @rfc, @calle,"& _ 
                " @numeroInterior, @numeroExterior, @colonia, @delegacion, @estado, @pais, @codig"& _ 
                "oPostal, @idMoneda, @condicionesDePago, @idRegimenFiscal)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@idMoneda", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 18, 0, "idMoneda", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@idRegimenFiscal", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 18, 0, "idRegimenFiscal", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        idEmpresas, razonSocial, rfc, calle, numeroInterior, numeroExterior"& _ 
                ", colonia, delegacion, estado, pais, codigoPostal, idMoneda, condicionesDePago, "& _ 
                "idRegimenFiscal"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            CXP_Empresas"
        ...
        Public Overloads Overridable Function Insert(ByVal razonSocial As String, ByVal rfc As String, ByVal calle As String, ByVal numeroInterior As String, ByVal numeroExterior As String, ByVal colonia As String, ByVal delegacion As String, ByVal estado As String, ByVal pais As String, ByVal codigoPostal As String, ByVal idMoneda As Global.System.Nullable(Of Decimal), ByVal condicionesDePago As String, ByVal idRegimenFiscal As Global.System.Nullable(Of Decimal)) As Integer
            ...
            If (idMoneda.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(10).Value = CType(idMoneda.Value,Decimal)
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(11).Value = CType(condicionesDePago,String)
            End If
            If (idRegimenFiscal.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(12).Value = CType(idRegimenFiscal.Value,Decimal)
            Else
