...
#Region " Default values "
    ...
    Private DefaultTitle As String = "ShowMsg Demo"
...
#Region " ShowMsg methods - get confirmation "
    ...
    Public Function ShowMsg(ByVal Text As String, ByVal Question As String,
    ByVal Buttons As ShowMsgButtons) As DialogResult
        Return ShowMsg(Text, Question, Buttons, ShowMsgDefaultButton.Button1, DefaultTitle)
    End Function

    Public Function ShowMsg(ByVal Text As String, ByVal Question As String,
    ByVal Buttons As ShowMsgButtons, ByVal DefaultButton As ShowMsgDefaultButton) As DialogResult
        Return ShowMsg(Text, Question, Buttons, DefaultButton, DefaultTitle)
    End Function

    Public Function ShowMsg(ByVal Text As String, ByVal Question As String,
    ByVal Buttons As ShowMsgButtons, ByVal DefaultButton As ShowMsgDefaultButton,
...
#Region " ShowMsg methods - standardized messages "
    ...
    Public Function ShowAccessDenied() As DialogResult
        Return ShowMsg("You do not have sufficient permission to perform requested operation.",
        ShowMsgImage.Security, "Access violation")
    End Function

    Public Function ShowUnderConstruction() As DialogResult
        Return ShowMsg("The requested feature is unavailable at this time.",
        ShowMsgImage.UnderConstruction)
    End Function
