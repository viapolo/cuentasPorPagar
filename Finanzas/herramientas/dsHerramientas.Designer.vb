...
Namespace dsHerramientasTableAdapters
    ...
    Partial Public Class CXP_ProveedoresTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(2).CommandText = "SELECT Clabe, activo, activoS, adjuntaComprobante, autorizaP1, autorizaP2, autori"& _ 
                "zado, autorizadoS, banco, calle, colonia, cp, cuentaBancaria, cuentaContablePaga"& _ 
                "r, curp, delegacion, empresa, estado, extranjero, fPagoInicial, fechaRegistro, i"& _ 
                "dProveedor, idSucursal, localidad, mail, montoMaxTransaccion, motivoRechazo, nac"& _ 
                "ionalidad, nit, notificaContabilidad, notificaPago, pais, razonSocial, relaciona"& _ 
                "do, rfc, usuarioSolicita FROM CXP_Proveedores WHERE (activoS = 'ACTIVO') AND (au"& _ 
    ...
    Partial Public Class DatosPagosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        CXP_CorreosProveedores.idCorreo, CXP_CorreosProveedores.idProveedor"& _ 
                ", CXP_CorreosProveedores.direccionCorreo, ISNULL(CXP_Proveedores.notificaPago, 0"& _ 
                ") AS notificaPago, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         ISNULL(CXP_Proveedores.adjuntaComp"& _ 
                "robante, 0) AS adjuntaComprobante, ISNULL(CXP_Proveedores.notificaContabilidad, "& _ 
                "0) AS notificaContabilidad"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            CXP_CorreosProveedores RIGHT OUTER J"& _ 
                "OIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         CXP_Proveedores ON CXP_CorreosProveedores.idProvee"& _ 
                "dor = CXP_Proveedores.idProveedor"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (CXP_CorreosProveedores.idProvee"& _ 
                "dor = @idProveedor)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@idProveedor", Global.System.Data.SqlDbType.[Decimal], 9, Global.System.Data.ParameterDirection.Input, 18, 0, "idProveedor", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
    ...
    Partial Public Class CXP_PagosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        CXP_PagosTesoreria.tipoSolicitud, CXP_PagosTesoreria.fechaPago, CXP"& _ 
                ...
                "     Vw_CXP_Autorizaciones ON CXP_PagosTesoreria.tipoSolicitud = Vw_CXP_Autoriza"& _ 
                "ciones.tipoSolicitud AND CXP_PagosTesoreria.folioSolicitud = Vw_CXP_Autorizacion"& _ 
                "es.folioSolicitud AND "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         CXP_PagosTesoreria.idEmpresa = "& _ 
                "Vw_CXP_Autorizaciones.idEmpresas"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (CXP_PagosTesoreria.tipoSolicitud"& _ 
                " = @tipoSolicitud) AND (Vw_CXP_Autorizaciones.idEmpresas = @idEmpresas) AND (Vw_"& _ 
                "CXP_Autorizaciones.folioSolicitud = @folioSolicitud)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
    ...
    Partial Public Class CXP_ConceptosTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        idConcepto, nombre, cuentaEgreso, impuesto, tipoProducto, cuentaPro"& _ 
                "v, idEmpresa, tipoConcepto, eventoContable, ctaCargoPago, ctaAbonoPago, omisionE"& _ 
                "C"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            CXP_Conceptos"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (idEmpresa = @idEmpresa) AND (cue"& _ 
                "ntaProv = @idCuenta) OR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         (cuentaEgreso = @idCuenta) OR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         (ctaCargoPago = @idCuenta) OR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                       "& _ 
                "  (ctaAbonoPago = @idCuenta)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@idCuenta", Global.System.Data.SqlDbType.VarChar, 5, Global.System.Data.ParameterDirection.Input, 0, 0, "cuentaProv", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As dsHerramientas.CXP_ConceptosDataTable, ByVal idEmpresa As Global.System.Nullable(Of Decimal)) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData(ByVal idEmpresa As Global.System.Nullable(Of Decimal)) As dsHerramientas.CXP_ConceptosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (idEmpresa.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(idEmpresa.Value,Decimal)
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            End If
            Dim dataTable As dsHerramientas.CXP_ConceptosDataTable = New dsHerramientas.CXP_ConceptosDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function ObtieneCuentas_FillBy(ByVal dataTable As dsHerramientas.CXP_ConceptosDataTable, ByVal idEmpresa As Global.System.Nullable(Of Decimal), ByVal idCuenta As String) As Integer
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(1).Value = CType(idCuenta,String)
            End If
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function ObtieneCuentas_GetDataBy(ByVal idEmpresa As Global.System.Nullable(Of Decimal), ByVal idCuenta As String) As dsHerramientas.CXP_ConceptosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (idEmpresa.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(idEmpresa.Value,Decimal)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As dsHerramientas.CXP_ConceptosDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
